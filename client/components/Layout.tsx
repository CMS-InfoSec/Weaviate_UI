    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-1 flex-col bg-sidebar border-r border-sidebar-border">
          <div className="h-16 px-6 text-xl text-sidebar-foreground">
            CMS Weaviate Admin
          </div>
      ...
      <div className="lg:pl-64">
        {/* Mobile header */}
        <div className="lg:hidden flex h-16 items-center justify-between px-4 border-b border-border bg-background">
